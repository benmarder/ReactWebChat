    ...
    return (
      <div>
        <div id="landing">
          ...
          <h2 style={styles.intro}>This is the best chat ever built by the finest engineers<br />from all over the world</h2>
          <form style={styles.form} action="" onSubmit={this.validate}>
            <input style={styles.input} type="text " placeholder="Please enter a nickname (1-6 characters)" required />
